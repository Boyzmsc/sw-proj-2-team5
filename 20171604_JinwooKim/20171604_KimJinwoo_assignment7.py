...
class Button(QToolButton):
    ...
    def sizeHint(self):  # 기본적인 QToolButton의 사이즈를 조정=ㄹ
...
class Calculator(QWidget):
    def __init__(self, parent=None):
        ...
        for k in range(0,10):
            self.digitButton[k] = Button('%d'%k, self.buttonClicked)
        ...
        for i in range(1,10):
            if i == 4:
                ...
                counter = 0
            numLayout.addWidget(self.digitButton[i], counter, counter2%3)
            counter2 += 1
